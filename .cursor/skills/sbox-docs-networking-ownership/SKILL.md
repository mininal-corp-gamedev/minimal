---
name: sbox-docs-networking-ownership
description: Objects that are owned by a connection are simulated by that connection. Their position and their variables are all controlled by the controlling client.
---
# Ownership
